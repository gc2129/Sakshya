...
function DashboardPage({ documents, onRefresh, lastSync, loading, apiOnline, apiError, permissions = {} }) {
  ...
  return (
    <div className="dashboard-page">
      ...
      {permissions.offlineSync && <OfflineSyncPanel documents={documents} apiOnline={apiOnline} />}
    </div>
  );
}
